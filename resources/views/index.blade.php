            ...
            <div class="hero__slider--wrapper swiper-wrapper">
                <div class="swiper-slide ">
                    <div class="hero__slider--items home1-slider1-bg">
                        ...
                        <div class="hero__slider--layer">
                            <img class="slider__layer--img " src="img/slider/home1-slider1-layer.webp"
                                 alt="slider-img">
                        </div>
                    </div>
                </div>
                <div class="swiper-slide ">
                    <div class="hero__slider--items home1-slider1-bg">
                        ...
                        <div class="hero__slider--layer">
                            <img class="slider__layer--img " src="img/slider/home1-slider2-layer.webp"
                                 alt="slider-img">
                        </div>
                    </div>
                </div>
                <div class="swiper-slide ">
                    <div class="hero__slider--items home1-slider1-bg">
                        ...
                        <div class="hero__slider--layer">
                            <img class="slider__layer--img " src="img/slider/home1-slider3-layer.webp"
                                 alt="slider-img">
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row  mb--n30">
            <div class="col-lg-6 col-md-6 mb-30">
                <div class="banner__items position__relative">
                    <a class="banner__thumbnail display-block" href="shop.html"><img
                            class="banner__thumbnail--img banner__max--height" src="img/banner/banner1.webp"
                            alt="banner-img">
            ...
            <div class="col-lg-6 col-md-6 mb-30">
                <div class="banner__items position__relative">
                    <a class="banner__thumbnail display-block" href="shop.html"><img
                            class="banner__thumbnail--img banner__max--height" src="img/banner/banner2.webp"
                            alt="banner-img">
                        ...
                        <div class="product__card--thumbnail">
                            <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                <img class="product__card--thumbnail__img product__primary--img"
                                     src="img/product/main-product/product1.webp" alt="product-img">
                                <img class="product__card--thumbnail__img product__secondary--img"
                                     src="img/product/main-product/product4.webp" alt="product-img">
                            </a>
                            <span class="product__badge">-14%</span>
                            <ul class="product__card--action d-flex align-items-center justify-content-center">
                                <li class="product__card--action__list">
                                    <a class="product__card--action__btn" title="Quick View" data-open="modal1"
                ...
                <div class="swiper-slide">
                    <article class="product__card">
                        <div class="product__card--thumbnail">
                            <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                <img class="product__card--thumbnail__img product__primary--img"
                                     src="img/product/main-product/product2.webp" alt="product-img">
                                <img class="product__card--thumbnail__img product__secondary--img"
                                     src="img/product/main-product/product3.webp" alt="product-img">
                            </a>
                        ...
                        <div class="product__card--content">
                            ...
                            <h3 class="product__card--title"><a href="product-details.html">Lorem ipsum dolor, sit amet
                                    adipisi elit. </a></h3>
                            <div class="product__card--price">
                ...
                <div class="swiper-slide">
                    <article class="product__card">
                        ...
                        <div class="product__card--content">
                            ...
                            <h3 class="product__card--title"><a href="product-details.html">Taboriosam aenda et itaque
                                    expcabo.</a></h3>
                            <div class="product__card--price">
                ...
                <div class="swiper-slide">
                    <article class="product__card">
                        ...
                        <div class="product__card--content">
                            ...
                            <h3 class="product__card--title"><a href="product-details.html">Eius doloribus dicta labore
                                    magni nulla! </a></h3>
                            <div class="product__card--price">
    ...
    <div class="container">
        <div class="discount__banner--thumbnail">
            <a class="display-block position-relative" href="#"><img class="discount__banner--thumbnail__img"
                                                                     src="img/banner/discount-bg.webp"
                                                                     alt="banner-img">
        ...
        <div class="section__heading section__heading--flex border-bottom d-flex justify-content-between mb-30">
            ...
            <ul class="nav tab__btn--wrapper" role="tablist">
                <li class="tab__btn--item" role="presentation">
                    <button class="tab__btn--link active" data-bs-toggle="tab" data-bs-target="#recent" type="button"
                            role="tab" aria-selected="true"> Recent
                    </button>
                </li>
                <li class="tab__btn--item" role="presentation">
                ...
                <li class="tab__btn--item" role="presentation">
                    <button class="tab__btn--link" data-bs-toggle="tab" data-bs-target="#top" type="button" role="tab"
                            aria-selected="false">
                        Top
                    </button>
                </li>
                <li class="tab__btn--item" role="presentation">
                    <button class="tab__btn--link" data-bs-toggle="tab" data-bs-target="#new" type="button" role="tab"
                            aria-selected="false">
                        New Arrivals*
                    </button>
                </li>
                ...
                <div class="col-lg-3">
                    <div class="sidebar__category">
                        <div class="choose__category--content">
                            ...
                            <ul class="choose__category--menu">
                                <li class="choose__category--menu__list">
                                    <svg class="choose__category--menu__icon" width="7" height="12" viewBox="0 0 7 12"
                                         fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M7 6.00003L1.26232 12L0 10.68L4.47539 6L0 1.32002L1.26232 0L7 6.00003Z"
                                              fill="currentColor"/>
                                    </svg>
                        ...
                        <div class="choose__category--banner position__relative">
                            <a class="banner__thumbnail display-block" href="shop.html"><img
                                    class="banner__thumbnail--img" src="img/banner/banner3.webp"
                                    alt="banner-img">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-6 custom-col mb-30">
                                        <article class="product__card">
                                            <div class="product__card--thumbnail">
                                                <a class="product__card--thumbnail__link display-block"
                                                   href="product-details.html">
                                                    <img class="product__card--thumbnail__img product__primary--img"
                                                         src="img/product/main-product/product5.webp"
                                                         alt="product-img">
                                                    <img class="product__card--thumbnail__img product__secondary--img"
                                                         src="img/product/main-product/product6.webp"
                                                         alt="product-img">
                                                </a>
                                                <span class="product__badge">-14%</span>
                                                <ul class="product__card--action d-flex align-items-center justify-content-center">
                                            ...
                                            <div class="product__card--content">
                                                ...
                                                <h3 class="product__card--title"><a href="product-details.html">Amazon
                                                        Cloud Cam Security
                                                        Camera </a></h3>
                                                <div class="product__card--price">
                                                    <span class="current__price">$239.52</span>
                                        ...
                                        <article class="product__card">
                                            <div class="product__card--thumbnail">
                                                <a class="product__card--thumbnail__link display-block"
                                                   href="product-details.html">
                                                    <img class="product__card--thumbnail__img product__primary--img"
                                                         src="img/product/main-product/product7.webp"
                                                         alt="product-img">
                                                    <img class="product__card--thumbnail__img product__secondary--img"
                                                         src="img/product/main-product/product8.webp"
                                                         alt="product-img">
                                                </a>
                                                <span class="product__badge">-11%</span>
                                                <ul class="product__card--action d-flex align-items-center justify-content-center">
                                            ...
                                            <div class="product__card--content">
                                                ...
                                                <h3 class="product__card--title"><a href="product-details.html">Lorem
                                                        ipsum dolor, sit amet adipisi elit. </a></h3>
                                                <div class="product__card--price">
                                                    <span class="current__price">$220.52</span>
                                                    <span class="old__price"> $315.00</span>
                                                </div>
                                        ...
                                        <article class="product__card">
                                            <div class="product__card--thumbnail">
                                                <a class="product__card--thumbnail__link display-block"
                                                   href="product-details.html">
                                                    <img class="product__card--thumbnail__img product__primary--img"
                                                         src="img/product/main-product/product9.webp"
                                                         alt="product-img">
                                                    <img class="product__card--thumbnail__img product__secondary--img"
                                                         src="img/product/main-product/product10.webp"
                                                         alt="product-img">
                                                </a>
                                                <span class="product__badge">-18%</span>
                                                <ul class="product__card--action d-flex align-items-center justify-content-center">
                                            ...
                                            <div class="product__card--content">
                                                ...
                                                <h3 class="product__card--title"><a href="product-details.html">Taboriosam
                                                        asnda et itaque expcabo.</a></h3>
                                                <div class="product__card--price">
                                                    <span class="current__price">$215.52</span>
                                                    <span class="old__price"> $345.00</span>
                                                </div>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-6 custom-col mb-30">
                                        <article class="product__card">
                                            ...
                                            <div class="product__card--content">
                                                ...
                                                <h3 class="product__card--title"><a href="product-details.html">Eius
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-6 custom-col mb-30">
                                        <article class="product__card">
                                            ...
                                            <div class="product__card--content">
                                                ...
                                                <h3 class="product__card--title"><a href="product-details.html">Sequi
                                                        eum saepe nisi repellat at fuga nemo. </a></h3>
                                                <div class="product__card--price">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="single__product--thumbnail">
                                            <a class="single__product--thumbnail__link display-block"
                                               href="product-details.html">
                                                <img class="single__product--thumbnail__img"
                                                     src="img/product/big-product/product6.webp"
                                                     alt="product-img">
                                            </a>
                                            <span class="product__badge style__left">-14%</span>
                                            <span class="product__badge--new">New</span>
                        ...
                        <div class="single__product--nav swiper">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="single__product--nav__items">
                                        <img class="single__product--nav__thumbnail"
                                             src="img/product/small-product/product5.webp" alt="product-nav-img">
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="single__product--nav__items">
                ...
                <div class="col-lg-3 offset-lg-0 col-md-6 offset-md-3">
                    <div class="product__sidebar small__product position-relative">
                            ...
                            <div class="swiper-wrapper">
                                    ...
                                    <div class="small__product--card d-flex">
                                        <div class="small__product--thumbnail">
                                            <a class="display-block" href="product-details.html"><img
                                                    src="img/product/small-product/product6.webp"
                                                    alt="product-img"></a>
                                        </div>
                                        <div class="small__product--content">
                                            <h3 class="small__product--card__title"><a href="product-details.html">Black
                                                    Air Pods </a></h3>
                                ...
                                <div class="swiper-slide">
                                    <div class="small__product--card d-flex">
                                        <div class="small__product--thumbnail">
                                            <a class="display-block" href="product-details.html"><img
                                                    src="img/product/small-product/product7.webp"
                                                    alt="product-img"></a>
                                        </div>
                                        <div class="small__product--content">
                                            <h3 class="small__product--card__title"><a href="product-details.html">Amazon
                                                    Cloud </a></h3>
                                            <div class="small__product--card__price">
                                ...
                                <div class="swiper-slide">
                                    <div class="small__product--card d-flex">
                                        <div class="small__product--thumbnail">
                                            <a class="display-block" href="product-details.html"><img
                                                    src="img/product/small-product/product8.webp"
                                                    alt="product-img"></a>
                                        </div>
                                        <div class="small__product--content">
                                ...
                                <div class="swiper-slide">
                                    <div class="small__product--card d-flex">
                                        <div class="small__product--thumbnail">
                                            <a class="display-block" href="product-details.html"><img
                                                    src="img/product/small-product/product9.webp"
                                                    alt="product-img"></a>
                                        </div>
                                        <div class="small__product--content">
                                            <h3 class="small__product--card__title"><a href="product-details.html">Nost
                                                    nobis are! </a></h3>
                                            <div class="small__product--card__price">
                                                <span class="current__price">$220.52</span>
                                            </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="small__product--card d-flex">
                                        ...
                                        <div class="small__product--content">
                                            <h3 class="small__product--card__title"><a href="product-details.html">Volup
                                                    quasi illo. </a></h3>
                                            <div class="small__product--card__price">
                        ...
                        <div class="small__product--swiper__btn swiper-button-next">
                            <svg width="13" height="17" viewBox="0 0 7 12" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M1.4481 11.2165C1.30673 11.3579 1.13932 11.4286 0.945871 11.4286C0.752418 11.4286 0.585008 11.3579 0.443639 11.2165C0.30227 11.0751 0.231586 10.9077 0.231586 10.7143L0.231586 0.714286C0.231586 0.520833 0.30227 0.353423 0.443639 0.212054C0.585008 0.0706845 0.752418 0 0.945871 0C1.13932 0 1.30673 0.0706845 1.4481 0.212054L6.4481 5.21205C6.58947 5.35342 6.66016 5.52083 6.66016 5.71429C6.66016 5.90774 6.58947 6.07515 6.4481 6.21652L1.4481 11.2165Z"
                                    fill="currentColor"/>
                            </svg>
                        </div>
            ...
            <div class="row">
                                ...
                                <article class="product__card">
                                    <div class="product__card--thumbnail">
                                        <a class="product__card--thumbnail__link display-block"
                                           href="product-details.html">
                                            <img class="product__card--thumbnail__img product__primary--img"
                                                 src="img/product/main-product/product11.webp" alt="product-img">
                                            <img class="product__card--thumbnail__img product__secondary--img"
                                                 src="img/product/main-product/product12.webp" alt="product-img">
                                        </a>
                                        <span class="product__badge">-14%</span>
                                        <ul class="product__card--action d-flex align-items-center justify-content-center">
                                            <li class="product__card--action__list">
                                    ...
                                    <div class="product__card--content">
                                        ...
                                        <h3 class="product__card--title"><a href="product-details.html">Amazon Cloud Cam
                                                Security
                                                Camera </a></h3>
                                        <div class="product__card--price">
                                            <span class="current__price">$239.52</span>
                                ...
                                <article class="product__card">
                                        ...
                                        <a class="product__card--thumbnail__link display-block"
                                           href="product-details.html">
                                            <img class="product__card--thumbnail__img product__primary--img"
                                                 src="img/product/main-product/product12.webp" alt="product-img">
                                            <img class="product__card--thumbnail__img product__secondary--img"
                                                 src="img/product/main-product/product13.webp" alt="product-img">
                                        </a>
                                        <span class="product__badge">-11%</span>
                                        <ul class="product__card--action d-flex align-items-center justify-content-center">
                                            <li class="product__card--action__list">
                                    ...
                                    <div class="product__card--content">
                                        ...
                                        <h3 class="product__card--title"><a href="product-details.html">Lorem ipsum
                                                dolor, sit amet adipisi elit. </a></h3>
                                        <div class="product__card--price">
                                            <span class="current__price">$220.52</span>
                                            <span class="old__price"> $315.00</span>
                                        </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 d-none d-lg-block mb-30">
                                <article class="product__card">
                                    ...
                                    <div class="product__card--content">
                                        ...
                                        <h3 class="product__card--title"><a href="product-details.html">Taboriosam asnda
                                                et itaque expcabo.</a></h3>
                                        <div class="product__card--price">
                                            <span class="current__price">$215.52</span>
                                            <span class="old__price"> $345.00</span>
                                        </div>
                        ...
                        <div class="row  mb--n30">
                            <div class="col-lg-6 col-md-6 mb-30">
                                <div class="banner__items position__relative">
                                    <a class="banner__thumbnail display-block" href="shop.html"><img
                                            ...
                                            src="img/banner/banner5.webp" alt="banner-img">
                            ...
                            <div class="col-lg-6 col-md-6 mb-30">
                                <div class="banner__items position__relative">
                                    <a class="banner__thumbnail display-block" href="shop.html"><img
                                            class="banner__thumbnail--img banner__max--height"
                                            src="img/banner/banner6.webp" alt="banner-img">
                                        <div class="banner__content style__right">
                                            <span class="banner__badge--style2">New</span>
                                            <h2 class="banner__content--title"> Toyota Car light</h2>
                                            <span class="banner__content--subtitle text-white">Deals <span
                                                    class="text__secondary">35% Flat</span></span> <br>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="banner__sidebar position__relative">
                        <a class="banner__thumbnail display-block" href="shop.html"><img class="banner__thumbnail--img"
                            ...
                            <div class="banner__content style__top">
                                ...
                                <h2 class="banner__content--title">Toyota <br> <span
                                        class="banner__content--title__inner">Car</span> Exhust</h2>
                ...
                <div class="small__product--step">
                    ...
                    <div class="small__product--step__inner">
                        <div class="small__product--card style2 d-flex mb-25">
                            <div class="small__product--thumbnail">
                                <a class="display-block" href="product-details.html"><img
                                        src="img/product/small-product/product6.webp" alt="product-img"></a>
                            </div>
                            <div class="small__product--content">
                                <ul class="rating small__product--rating d-flex">
                                    <li class="rating__list">
                        ...
                        <div class="small__product--card style2 d-flex mb-25">
                            <div class="small__product--thumbnail">
                                <a class="display-block" href="product-details.html"><img
                                        src="img/product/small-product/product7.webp" alt="product-img"></a>
                            </div>
                            <div class="small__product--content">
                                <ul class="rating small__product--rating d-flex">
                                    <li class="rating__list">
                        ...
                        <div class="small__product--card style2 d-flex">
                            <div class="small__product--thumbnail">
                                <a class="display-block" href="product-details.html"><img
                                        src="img/product/small-product/product9.webp" alt="product-img"></a>
                            </div>
                            <div class="small__product--content">
                                <ul class="rating small__product--rating d-flex">
                                    <li class="rating__list">
                ...
                <div class="small__product--step">
                    ...
                    <div class="small__product--step__inner">
                        <div class="small__product--card style2 d-flex mb-25">
                            <div class="small__product--thumbnail">
                                <a class="display-block" href="product-details.html"><img
                                        src="img/product/small-product/product1.webp" alt="product-img"></a>
                            </div>
                            <div class="small__product--content">
                                <ul class="rating small__product--rating d-flex">
                                    <li class="rating__list">
                        ...
                        <div class="small__product--card style2 d-flex mb-25">
                            <div class="small__product--thumbnail">
                                <a class="display-block" href="product-details.html"><img
                                        src="img/product/small-product/product2.webp" alt="product-img"></a>
                            </div>
                            <div class="small__product--content">
                                <ul class="rating small__product--rating d-flex">
                                    <li class="rating__list">
                        ...
                        <div class="small__product--card style2 d-flex">
                            <div class="small__product--thumbnail">
                                <a class="display-block" href="product-details.html"><img
                                        src="img/product/small-product/product3.webp" alt="product-img"></a>
                            </div>
                            <div class="small__product--content">
                                <ul class="rating small__product--rating d-flex">
                                    <li class="rating__list">
                ...
                <div class="small__product--step">
                    ...
                    <div class="small__product--step__inner">
                        <div class="small__product--card style2 d-flex mb-25">
                            <div class="small__product--thumbnail">
                                <a class="display-block" href="product-details.html"><img
                                        src="img/product/small-product/product4.webp" alt="product-img"></a>
                            </div>
                            <div class="small__product--content">
                                <ul class="rating small__product--rating d-flex">
                                    <li class="rating__list">
                        ...
                        <div class="small__product--card style2 d-flex mb-25">
                            <div class="small__product--thumbnail">
                                <a class="display-block" href="product-details.html"><img
                                        src="img/product/small-product/product5.webp" alt="product-img"></a>
                            </div>
                            <div class="small__product--content">
                                <ul class="rating small__product--rating d-flex">
                                    <li class="rating__list">
                        ...
                        <div class="small__product--card style2 d-flex">
                            ...
                            <div class="small__product--content">
                                ...
                                <h3 class="small__product--card__title"><a href="product-details.html">Conseqr adipis
                                        and. </a></h3>
                                <div class="product__card--price">
            ...
            <div class="swiper-wrapper">
                    ...
                    <div class="blog__card">
                        <div class="blog__card--thumbnail">
                            <a class="blog__card--thumbnail__link" href="blog-details.html"><img
                                    class="blog__card--thumbnail__img" src="img/blog/blog1.webp" alt="blog-img"></a>
                ...
                <div class="swiper-slide">
                    <div class="blog__card">
                        <div class="blog__card--thumbnail">
                            <a class="blog__card--thumbnail__link" href="blog-details.html"><img
                                    class="blog__card--thumbnail__img" src="img/blog/blog2.webp" alt="blog-img"></a>
                ...
                <div class="swiper-slide">
                    <div class="blog__card">
                        <div class="blog__card--thumbnail">
                            <a class="blog__card--thumbnail__link" href="blog-details.html"><img
                                    class="blog__card--thumbnail__img" src="img/blog/blog3.webp" alt="blog-img"></a>
